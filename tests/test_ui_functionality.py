...
class TestSearchPageBehavior:
    ...
    def test_set_details(self, search_page: SearchPage, qtbot: QtBot):
        ...
        assert (
            'href="http://example.com/datasheet.pdf"'
            in search_page.datasheetLink.text()
        )
