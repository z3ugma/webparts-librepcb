...
from PySide6.QtWidgets import (
    QWidget, QVBoxLayout, QFrame, QGraphicsView, 
    QGraphicsScene, QGraphicsPixmapItem, QGraphicsTextItem, QPushButton
)
...
class LibraryElementSidebar(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        if self.context_frame:
            ...
            self.hero_view = self.context_frame.findChild(QGraphicsView, "image_hero_view")
    ...
    def _set_hero_pixmap(self, pixmap: QPixmap):
        if not pixmap.isNull():
            ...
            QTimer.singleShot(0, lambda: self.hero_view.fitInView(self.hero_pixmap_item, Qt.KeepAspectRatio))
        else:
            self._set_hero_text(UIText.IMAGE_NOT_AVAILABLE.value)
